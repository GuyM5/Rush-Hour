...
class DQN_Agent:
    ...
    def get_Actions (self, states_tensor: State, dones) -> torch.tensor: # מחזיר לי טנסור של טבלת מהלכים
        actions = []
    ...
    def get_Actions_Values (self, states): #מחזיר לי טבלה של הערכים הכי טובים ושל המהלכים הכי טובים
        with torch.no_grad():
